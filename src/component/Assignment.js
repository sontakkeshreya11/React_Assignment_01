...
function Assignment(){ 
    ...
    const afterSubmit=(event)=>
    {
        ...
        const whitespacehead=addData.head.indexOf(" ");
        const whitespacedesc=addData.desc.indexOf(" ");
        if((!addData.head )|| (!addData.desc) || (checkd!==-1) || (checkt!==-1)|| (whitespacehead===0) || (whitespacedesc===0))
        {
